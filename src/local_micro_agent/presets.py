...
_SEARCH: dict[str, Any] = {
    ...
    "semantic_failure_family_ban": True,
    "semantic_failure_family_threshold": 2,
    "semantic_failure_family_window": 8,
    "semantic_failure_family_cooldown_loops": 12,
    "semantic_failure_family_reject_pre_apply": True,
...
_SPEC: dict[str, Any] = {
    **_STRUCTURAL,
    ...
    "spec_reseed_reserved_synth_calls": 4,
    ...
    "spec_micro_probe_max_hunks": 1,
    "spec_micro_probe_max_changed_lines": 15,
    "spec_micro_probe_max_changed_functions": 1,
    ...
    "spec_metric_neutral_plateau": True,
