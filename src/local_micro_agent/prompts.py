...
def spec_hypothesis_repair_prompt(
    ...
    *,
    ...
    user = (
        ...
        "structural/vectorization-scale behavior.\n"
        "- Do not return change_boundary.kind=local_edit for options that mention "
        "vectorizing, SIMD, reordering, packing, scheduling, an entire loop, or "
        "global instruction-list behavior. Those shapes must be "
        "structural_probe/structural_expand unless rewritten as one guarded "
        "statement-level local edit.\n"
